...
export default function MobileNavigation() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}  >
      <AppBar position="static"className="!bg-[#011341]">
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
      ...
      <Menu
        ...
        className="!overflow-y-scroll glass !text-black"
      >
        <List className={` !bg-[#011341] shadow-md  !relative !overflow-y-scroll !p-2  `}>
          {all_Data?.map((nav) => (
