...
const Changepassword = () => {
  ...
  return (
    <div className="w-[100%]   flex justify-center items-center">
      <div className="!bg-white !bg-opacity-10 lg:w-1/2 p-4">
        <p className="!text-center !text-white font-bold !py-4 text-lg">Change Password</p>
        <div className="grid grid-cols-1 gap-[6%] gap-y-4 w-full">
          ...
          <div>
            <p className="font-bold !text-white">New Password</p>
            <TextField
              fullWidth
              className="!bg-white"
              id="new_password"
