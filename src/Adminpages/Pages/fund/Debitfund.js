  ...
  return (
    <div className="!flex justify-center items-center w-full">
      <div className="p-5 lg:w-1/2 md:w-3/4 w-full bg-white !bg-opacity-10 !rounded-lg">
        <p className="!text-center font-bold !py-4 !text-white text-lg">Debit Fund</p>
        <div className="grid grid-cols-1 gap-[6%] gap-y-4">
          <div>
            ...
            {fk.values.user_id ? (
              result ? (
                <div className="no-error !text-white flex justify-between">
            ...
            <p className="!text-white font-bold mt-5">Wallet Type</p>
            <TextField
              className="!bg-white"
              fullWidth
              select
