...
useEffect(() => {
  ...
  return (
    ...
    <div className="w-[100%]  bg-white bg-opacity-5 glass flex justify-center items-center">
      <div className=" lg:w-full m-5 p-4">
      <p className="!text-center font-bold !text-white  !py-4 text-lg">Registration</p>
