...
export const API_URLS = {
    ...
    income_all: `/api/v1/tget-all-income-by-admin`,
    ...
    usdt_payingdata: `/api/v1/get-usdt-record-admin`,
    usdt_payoutdata: `/api/v1/get-usdt-record-admin`,
    ...
    wingo_amount_api: `/api/v1/get-wingo-result-on-slot`,
    trx_amount_api: `/api/v1/get-trx-result-on-slot`,
    k3_amount_api: `/api/v1/get-k3-result-on-slot`,
    admin_addess: `/api/v1/admin-qr-address`,
    upload_addess: `/api/v1/upload-qr-image-by-admin`,
    Admin_record: `/api/v1/get-usdt-record-admin`,
    daily_record: `/api/v1/tget-daily-salary-deposit-wise-admin-data`,
    ...
    trx_result_api: `/api/v1/update-trx-result`,
    k3_result_api: `/api/v1/update-k3-result`,
   ...
   team_referal_bonus_data: `/api/v1/getTeamReferralFirstListAdmin`,
    ...
    inviation_bonus_data: `/api/v1/tget-invitation-bonus-admin-data`,
    welcome_bonus_data: `/api/v1/tget-wlcm-bonus-admin-data`,
    winning_bonus_data: `/api/v1/tget-wngstrk-bonus-admin-data`,
    ...
    approval_payin_usdt: `/api/v1/approve-reject-usdt`,
    approval_payout_usdt: `/api/v1/approve-reject-usdt-payout`,
    cashback_bonus: `/api/v1/cash-back-bonus-list-admin`,
    Admin_record_usdt: `/api/v1/get-admin-usdt-address`,
    Admin_record_usdt_update: `/api/v1/update-admin-usdt-address`,
