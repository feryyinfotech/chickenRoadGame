...
export const slice = createSlice({
  ...
  initialState: {
    ...
    isEnableMusic: false,
    isEnableSound: false,
    isEnableMusicChickenG: true,
    isEnableSoundChickenG: false,
  ...
  reducers: {
    ...
    isEnableMusicFunction: (state) => {
      state.isEnableMusicChickenG = !state.isEnableMusicChickenG;
    },
    isEnableSoundFunction: (state) => {
      state.isEnableSoundChickenG = !state.isEnableSoundChickenG;
    },
    ...
    volume_handlerwingoFn: (state, actions) => {
      state.volume_handlerwingo = actions.payload;
    },
  },
});
