...
const Chart = ({ gid }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i <= 9; i++) {
      let res = game_history?.findIndex(
        (element) => element.tr41_slot_id === i
      );
  ...
  const game_history_data = React.useMemo(() => game_history, [game_history]);
  ...
  return (
    <Box className="chartTable" mt={2}>
      <Stack direction="row" className="onegotextbox">
        <Typography variant="body1" color="initial" className="!text-[#00ECBE]">
          {/* <Box
            component="img"
            src={history}
            width={25}
              ...
              >
                <div className="flex ">
                  ...
                  <Box className=" !ml-2 flex items-center justify-between gap-1 ">
                    ...
                    <div
                      id={`zero${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '0'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number   ${i?.tr41_slot_id?.toString() === '0'
                          ? '!bg-gradient-to-b from-[#e85053] to-[#8c06f2] !text-white !font-bold !text-[5px] '
                          : '!bg-black !text-white !border-[1px] !border-black  !text-[5px]  !opacity-80'
                          }`}
                      >
                        {' '}
                        0
                    ...
                    <div
                      id={`one${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '1'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number  ${i?.tr41_slot_id?.toString() === '1'
                    ...
                    <div
                      id={`two${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '2'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number   ${i?.tr41_slot_id?.toString() === '2'
                    ...
                    <div
                      id={`three${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '3'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number  ${i?.tr41_slot_id?.toString() === '3'
                    ...
                    <div
                      id={`four${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '4'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number ${i?.tr41_slot_id?.toString() === '4'
                    ...
                    <div
                      id={`five${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '5'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number ${i?.tr41_slot_id?.toString() === '5'
                    ...
                    <div
                      id={`six${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '6'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number ${i?.tr41_slot_id?.toString() === '6'
                    ...
                    <div
                      id={`seven${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '7'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number ${i?.tr41_slot_id?.toString() === '7'
                    ...
                    <div
                      id={`eight${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '8'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number  ${i?.tr41_slot_id?.toString() === '8'
                    ...
                    <div
                      id={`nine${indexi}`}
                      className={`${i?.tr41_slot_id?.toString() === '9'
                        ? '!z-20'
                        : '!z-[-10px]'
                        }`}
                    >
                      <Typography
                        className={`circleNumberbody-number  ${i?.tr41_slot_id?.toString() === '9'
