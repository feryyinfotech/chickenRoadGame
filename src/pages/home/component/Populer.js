...
function Populer({ alljiligames, getGamnesbyID }) {

    const style = {
        winbox: { background: 'linear-gradient(175deg, rgba(1,19,65,1) 0%, rgba(35,196,185,1) 100%)', borderRadius: '20px', height: '100px', marginBottom: '0px', },
        positiongame: {
