...
const K3History = () => {
  ...
  const { data: my_history, isLoading } = useQuery(
    ['my_all_history', game_id],
    async () => {
      return apiConnectorPost(endpoint.k3_my_history, { game_id });
    },
    {
  ...
  return (
    <Layout header={false}>
      <Container sx={{ background: '#05012B' }} className="h-screen">
        ...
        <FormControl className="!m-3 w-[95%]">
          <Select
            fullWidth
          ...
          >
            <MenuItem value={1}>k3 Lottery 1 Min</MenuItem>
            <MenuItem value={2}>k3 Lottery 3 Min</MenuItem>
            <MenuItem value={3}>k3 Lottery 5 Min</MenuItem>
            <MenuItem value={4}>k3 Lottery 10 Min</MenuItem>
          </Select>
        </FormControl>
        <Box>
