...
function Wingo10Min() {
  ...
  React.useEffect(() => {
    const handleFiveMin = (onemin) => {
      ...
      let fivemin = `${9 - (Number(t === 0 ? preValue : min) % 10)
        }_${time_to_be_intro}`;
      preValue = min;
      ...
      if (
        ...
        client.refetchQueries('my_game_history_4');
        client.refetchQueries('wallet_amount');
        client.refetchQueries('my_all_history_4');
        setTimeout(() => {
    ...
    <Box>
      ...
      <Box
        ...
        <div className="relative">
          {bettype === 1 && <BetNumber gid={'4'} />}
          {bettype === 2 && <Same2 gid={'4'} />}
          {bettype === 3 && <Same3 gid={'4'} />}
          {bettype === 4 && <Different gid={'4'} />}
