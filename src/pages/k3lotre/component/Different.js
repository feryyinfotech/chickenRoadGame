...
const Different = ({ timing, gid }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-white">3 of different numbers: odds (13.83)</p>
        <div className="flex gap-2 justify-center my-4 mx-1 cursor-pointer">
          {[1, 2, 3, 4, 5, 6].map(number => (
            <p
              key={number}
              className="!bg-[#4e2d8e] px-6 py-2 text-white rounded-md relative"
        ...
        <div className="flex gap-4 justify-center my-4 mx-1 cursor-pointer">
          {[" Any of the 3 number same : odd number"].map(number => (
            <p
              key={number}
              className="!bg-[#6a253c] p-2 px-10 text-white  rounded-md relative"
        ...
        <p className="text-white">2 of different numbers: odds (13.83)</p>
        <div className="flex gap-2 justify-center my-4 mx-1 cursor-pointer">
          {[1, 2, 3, 4, 5, 6].map(number => (
            <p
              key={number}
      ...
      {open && (
         ...
         <div className="content">
          <Box>
            ...
            {isChecked &&
              <div>
                <Typography className="!mt-1 !mx-2 text-white text-left">3 of different Number</Typography>
                <Box px={1}
      ...
      `}
            ...
            {Checked &&
              <div>
                <Typography className="!mt-4 !mx-2 text-white text-left">Any 3  Number</Typography>
                <Box px={1}
                  className="!flex  justify-start mx-2 gap-2 ">
                  ...
                  {selectNumber.map((number) => (
                    <Typography
                      ...
                      className={` !cursor-pointer !px-2 !w-fit !rounded !bg-[#6a253c] `}
                    >
            ...
            {Check &&
              <div>
                <Typography className="!mt-4 !mx-2 text-white text-left ">2 of different Number</Typography>
                <Box px={1}
                  className="!flex  justify-start mx-2 gap-2 ">
