...
function AddBankAccount() {
  ...
  return (
    <Container sx={{ background: '#05012B', height: '100vh' }}>
      ...
      <Box sx={{ width: '92%', margin: "auto", mb: 2, }}>
        <Stack direction='row' sx={{
          mt: 1,
          background: '#011341', boxShadow: ' rgba(149, 157, 165, 0.2) 0px 8px 24px;', padding: '5px', borderRadius: '25px', alignItems: 'center',
