...
export default function Ticket() {
  ...
  return (
    <Layout>
      ...
      >
        <div className="flex justify-between w-full items-center bg-[#011341] px-2 py-6 rounded-lg mt-3  " style={{ width: "95%", margin: '16px auto' }}>
          <div className="grid grid-cols-2 gap-1 items-center w-[430px] p-2">
            <span className="col-span-2 justify-end">
              <div className="flex justify-between">
                <span className="font-bold text-white">Ticket Generate</span>
              </div>
            </span>
            ...
            <TextField
              ...
              className="!w-[100%] !bg-[#05012B] !my-3"
              select
              size="small"
            >
            ...
            <textarea
              ...
              onChange={fk.handleChange}
              className="!w-[100%] !bg-[#05012B] !text-sm  !text-center !text-white pt-2 !my-3"
            />
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <p className="!px-5 !w-full !overflow-auto border-2 !border-gray-400 text-white !min-h-[100px]">
                  {i?.description}
                </p>
              </div>
              ...
              {String(isvisible) && index === isvisible && (
                <div className="!flex w-full ">
                  <img src={i?.file_name} className="!w-full !h-[430px]" />
                </div>
              )}
            </Box>
          );
