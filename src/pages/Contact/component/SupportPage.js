...
// import banner1 from '../../../assets/images/actbanner1.jpg';
// import banner7 from '../../../assets/images/banner7.jpg';
// import banner3 from '../../../assets/images/actbanner3.jpg';
import { project_name } from '../../../services/urls';
  ...
  return (
    <Box sx={{ background: 'white', padding: 1 }}>
      ...
      >
        <SwiperSlide>
          {' '}
          {/* <Box component="img" src={banner1}></Box> */}
        </SwiperSlide>
        <SwiperSlide>
          {' '}
          {/* <Box component="img" src={banner7}></Box> */}
        </SwiperSlide>
        {/* <SwiperSlide> <Box component='img' src={banner7}></Box></SwiperSlide> */}
        <SwiperSlide>
          {' '}
          {/* <Box component="img" src={banner3}></Box> */}
        </SwiperSlide>
      ...
      <Modal
        open={open}
        onClose={handleClose}
        sx={{ marginTop: '10%', overflow: 'scroll' }}
      >
        <Box
          sx={{
        ...
        >
          ...
          <Typography variant="body1" color="initial">
            Hello dear {project_name} Member
          </Typography>
          <Typography variant="body1" color="initial">
            Once you've submitted your concern, rest assured our support team is
            on it. To get started, follow these steps:
          </Typography>
          <Typography variant="body1" color="initial">
            Identify the issue from the options provided.
          </Typography>
          <Typography variant="body1" color="initial">
            Fill out the required fields with your information.
          </Typography>
          <Typography variant="body1" color="initial">
            Hit the 'Submit' button to send your request to our team.
          </Typography>
          <Typography variant="body1" color="initial">
            For updates, click the 'Status' button, enter your ID, select your
            query from the list, and press 'Search' to view the latest progress.
          </Typography>
          <Typography variant="body1" color="initial">
            To ensure an efficient resolution, please submit your concern just
            once and avoid multiple submissions. We're committed to addressing
            your issues promptly.
          </Typography>
          <Typography variant="body1" color="initial" sx={{ color: 'red' }}>
            कृपया अपनी पूछताछ की प्रगति को प्रभावित करने से बचने के लिए बार-बार
            आदेश प्रस्तुत न करें।
          </Typography>
          <Typography variant="body1" color="initial" sx={{ color: 'red' }}>
