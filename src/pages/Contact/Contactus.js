...
function Contactus() {
  ...
  return (
    <Container sx={{ height: '100vh' }}>
      <Box sx={{ padding: 1, background: 'linear-gradient(175deg, rgba(1,19,65,1) 0%, rgba(35,196,185,1) 100%)', px: 2, }}>
      ...
      <Box sx={{ padding: 1, background: 'linear-gradient(175deg, rgba(1,19,65,1) 0%, rgba(35,196,185,1) 100%)', }}>
        <Box component='img' src={customerBg} sx={{ width: '100%', height: '200px' }}></Box>
      </Box>
      <NavLink to='/ServiceCollections'>
        <Box sx={{ marginTop: '-30px', background: '#011341', borderRadius: '20px 20px 0px 0px', padding: 2 }}>
