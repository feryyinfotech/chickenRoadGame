            ...
            <TableBody>
              {visibleRows?.map((i, index) => (
                <TableRow key={i?.id}>
                  ...
                  <TableCell sx={{ color: 'white' }} className="!border !border-r !text-xs !text-center !border-b !border-white">{i?.l01_trans_type}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
