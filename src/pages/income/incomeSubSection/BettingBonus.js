...
function BettingBonus() {
  ...
  const { isLoading, data } = useQuery(
    ["Daily Return Compounding Income" ,reqbody],
      ...
      <Layout>
        ...
        >
          <Box sx={style.header}>
            ...
            <p>Daily Return Compounding Income</p>
          </Box>
          <div>
            ...
            <TableBody>
              {visibleRows?.map((i, index) => (
                <TableRow key={i?.id}>
                  ...
                  <TableCell sx={{ color: 'white' }} className="!border !border-r !text-xs !text-center !border-b !border-white">{i?.l01_trans_des}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
