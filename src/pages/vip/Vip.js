...
function VIPPage() {
  ...
  const res = data?.data?.data?.filter((i) => i?.l01_income_distributon === "Daily") || [];
  const res_monthly = data?.data?.data?.filter((i) => i?.l01_income_distributon === "Monthly") || [];
                    ...
                    <Box style={styles.rewardBox}>
                      <Box style={styles.rewardText}>
                        <Box
                          component="img"
                          src={vip01}
                          sx={{ width: "50px !important", filter: 'hue-rotate(105deg)', }}
                        />
                        <Box>
                          <Typography
                            variant="body1"
...
const styles = {
  ...
  vipStatValue: { fontFamily: "roboto !important", fontWeight: "bold", color: "#000" },
  vipStatLabel: { color: "#000" },
  vipLevelContainer: {
    borderRadius: "8px",
    padding: "8px",
    width: "100%",
