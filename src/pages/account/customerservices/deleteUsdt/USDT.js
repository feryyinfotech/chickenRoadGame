        ...
        <div className='!bg-white h-screen overflow-y-scroll'>
            ...
            <Container className="!h-screen !bg-gray-50 !p-4">
                <Box sx={style.header}>
                    ...
                    <Typography sx={{ width: '33%', }} className="fcc roboto !text-black !text-xl " variant="body1" color="initial">Self Services Delete Old....</Typography>
