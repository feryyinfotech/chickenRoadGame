        ...
        <div className='!bg-white h-screen overflow-y-scroll'>
            ...
            <Container className="!h-screen !bg-gray-50 !p-4">
                <Box sx={style.header}>
                    ...
                    <Typography sx={{ width: '33%', }} className="fcc roboto !text-black !text-xl " variant="body1" color="initial">Self Services Delete Bank....</Typography>
                ...
                <div className="mt-7 p-2">
                    ...
                    <div className="mt-2  flex justify-start items-center">
                        ...
                        <input
                            ...
                            className="mt-1 block w-[70%]  border border-gray-300 bg-white text-xl shadow-md text-gray-700 rounded-md py-3 px-3"
                            value={otp}
...
export default SelfServicesDeletebank;
