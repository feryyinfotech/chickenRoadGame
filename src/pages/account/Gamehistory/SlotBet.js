        ...
        >
          ...
          >
            <div className="grid grid-cols-2 gap-3 pt-2 m-3">
              ...
              <div
                className={`flex h-14 p-2 items-center gap-2 rounded-lg ${
                  value === '8' ? 'bg-[#58E7BF] ' : 'bg-[#001C54]'
                }`}
                onClick={() => ChangeHandler('8')}
              >
                <img src={evocas} className="w-12" />
                <p
                  className={`${
                    value === '8' ? 'text-[#070931]' : 'text-[#4466b4]'
                  }`}
                >
                  EVO_Electronic
                </p>
              ...
              <div
                className={`flex h-14 p-2 items-center gap-2 rounded-lg ${
                  value === '9' ? 'bg-[#58E7BF] ' : 'bg-[#001C54]'
                }`}
                onClick={() => ChangeHandler('9')}
              >
                <img src={nineg} className="w-12" />
                <p
                  className={`${
                    value === '9' ? 'text-[#070931]' : 'text-[#4466b4]'
                  }`}
                >
                  9G
                </p>
