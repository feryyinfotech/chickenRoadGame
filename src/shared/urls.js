...
export const endpoint = {
    ...
    get_all_transaction: `${game_domain}/api/v1/get-all-report`,
    vip_income: `${game_domain}/api/v1/vip-bonus`,
    vip_income_monthly: `${game_domain}/api/v1/vip-bonus-monthly`,
    wallet_withdrawl_request: `${game_domain}/api/v1/withdrawl-request`,
    view_usdt_address_recoprd: `${game_domain}/api/v1/usdt-address-record`,
    add_usdt_address: `${game_domain}/api/v1/add-usdt-address`,
    deposit_history_usdt: `${game_domain}/api/v1/deposit-history-usdt `,
    withdrwal_history_usdt: `${game_domain}/api/v1/withdrawal-history-usdt`,
    deposite_request: `${game_domain}/api/v1/payin-request`,
    popup_get: `${game_domain}/api/v1/get-front-popup`,
    ...
    winning_income: `${game_domain}/api/v1/winning-streak-bonus`,
    ...
    invitation_bonus: `${game_domain}/api/v1/invitation-bonus-income`,
    invitation_bonus_data: `${game_domain}/api/v1/get-invitation-bonus-data`,
    daily_bonus_dta: `${game_domain}/api/v1/daily-salary-icome-deposit-wise`,
    user_email: `${game_domain}/api/v1/user-email`,
    ...
    promotion_data: `${game_domain}/api/v1/get-promotion-data`,
    cashback_cashback: `${game_domain}/api/v1/getCashBack-report`,
    ...
    //k3 api
    k3_bet_placed_node: `${game_domain}/api/v1/k3-bet-placing`,
    k3_my_history: `${game_domain}/api/v1/k3-bet-user-history`,
    k3_game_history: `${game_domain}/api/v1/k3-bet-history`,
