...
const AutoPlayBtn1 = () => {
  ...
  return (
    <div className="!w-[430px] !bg-black ">
      <div
      ...
      >
        <div className="w-full h-auto flex justify-between">
          <p className="flex items-center gap-1">
            ...
            />
            <p
              className={`text-[10px] ${autoplayfk?.values.isCashDecrease
                  ? text_gray_dark
                  : text_gray_light
                }`}
            >
          ...
          <div className="flex items-center gap-1">
            ...
            >
              <CiCircleMinus
                className={`cursor-pointer text-2xl ${autoplayfk?.values.isCashDecrease
                    ? text_gray_dark
                    : text_gray_light
                  }`}
                onClick={() =>
            ...
            <p
              className={` ${autoplayfk?.values.isCashDecrease
                  ? text_gray_dark
                  : text_gray_light
                } text-[12px]`}
            >
